...
.admin-shell { min-height: 100vh; padding: 28px; }.admin-header { display: flex; align-items: end; justify-content: space-between; max-width: 1480px; margin: 0 auto 20px; }.admin-header small,.panel header small { color: #9a6824; font-size: 10px; font-weight: 900; letter-spacing: .12em; }.admin-header h1 { margin: 4px 0; font-size: 30px; }.admin-header p { margin: 0; color: #6d7d76; }.live { display: grid; grid-template-columns: 9px auto; align-items: center; gap: 2px 7px; }.live i { width: 9px; height: 9px; border-radius: 50%; background: #39a562; box-shadow: 0 0 0 6px #d9edde; }.live small { grid-column: 2; color: #819089; }.loading { display: grid; min-height: 60vh; place-items: center; }.overview-grid,.lower-grid { display: grid; max-width: 1480px; margin: 0 auto 18px; gap: 18px; }.overview-grid { grid-template-columns: minmax(0, 1.55fr) minmax(340px, .75fr); }.lower-grid { grid-template-columns: 1fr 1fr; }.panel { overflow: hidden; border: 1px solid #d7dfd5; border-radius: 20px; background: #fff; box-shadow: 0 12px 34px rgba(31,65,53,.07); }.panel > header { display: flex; align-items: center; justify-content: space-between; padding: 18px 20px; border-bottom: 1px solid #e4e9e2; }.panel h2 { margin: 3px 0 0; font-size: 18px; }.panel > header > span { color: #7c8b84; font-size: 11px; }.admin-map { height: 520px; }.heat-legend { display: flex; padding: 10px 20px 15px; align-items: center; justify-content: flex-end; gap: 8px; color: #77867f; font-size: 10px; }.heat-legend i { width: 130px; height: 8px; border-radius: 99px; background: linear-gradient(90deg,#8dc982,#f1bf3b,#e8432f); }.zone-list { display: grid; padding: 12px; gap: 8px; }.zone-list label,.stock-grid label { display: flex; padding: 12px; align-items: center; justify-content: space-between; gap: 10px; border-radius: 12px; background: #f4f7f2; }.zone-list label > span,.stock-grid label > span { display: grid; gap: 3px; }.zone-list strong,.stock-grid strong { font-size: 13px; }.zone-list small,.stock-grid small { color: #809088; font-size: 10px; }.zone-list select { min-width: 96px; height: 34px; border: 1px solid #cad6c8; border-radius: 9px; background: #fff; color: #285b48; }.stock-grid { display: grid; grid-template-columns: repeat(2, 1fr); padding: 14px; gap: 9px; }.stock-grid label.soldout { background: #fff0ec; }.stock-grid label.soldout small { color: #bc4d36; }.stock-grid input { width: 70px; height: 34px; border: 1px solid #ccd5c9; border-radius: 8px; text-align: center; }.lost-panel > header b { display: grid; min-width: 25px; height: 25px; place-items: center; border-radius: 99px; background: #b54630; color: #fff; font-size: 11px; }.report-list { display: grid; max-height: 360px; padding: 14px; overflow-y: auto; gap: 9px; }.report-list > article { padding: 12px; border: 1px solid #e2d4cc; border-radius: 12px; background: #fffaf7; }.report-list article header { display: flex; justify-content: space-between; }.report-list time { color: #8e7b70; font-size: 9px; }.report-list p { margin: 7px 0; color: #604f47; font-size: 11px; }.report-list button { margin-right: 5px; padding: 5px 8px; border: 1px solid #d8c9c0; border-radius: 7px; background: #fff; color: #80675c; font-size: 9px; }.report-list button.active { border-color: #325f4d; background: #325f4d; color: #fff; }.empty-reports { display: grid; min-height: 230px; place-items: center; color: #89968f; font-size: 12px; }
...
@media (max-width: 900px) { .admin-shell { padding: 14px; }.overview-grid,.lower-grid { grid-template-columns: 1fr; }.admin-header { align-items: start; }.admin-header h1 { font-size: 22px; }.admin-map { height: 430px; } }
</style>
